(function() {
    ...
    function show_message(result){
        switch(result) {
            case 1: 
                ...
                result_message.innerText = "Изменения успешно сохранены";
                break;
            case 0: 
                result_message.innerText = "Не удалось внести изменения. Попробуйте еще раз";
                break;
            default: 
    ...
    function send_data(){
        ...
        xhr.open('POST', '/task/edit', true); //true - запрос синхронный        
        xhr.send(formData);
