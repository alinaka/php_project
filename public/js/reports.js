//получить из базы нужные данные
//запрос в базу за данными - это контроллер + модель через ajax
//модель должна возвращать json, который потом нужно
//распарсить и вставить в качестве датасета
//плюс должны прийти лейблы - их тоже распарсить и вставить в качестве лейблов

//data = [1, 2, 3];
//labels = ['задача1', 'задача2', 'задача3']
$( function() {
...
function get_data(){
    ...
    function addDataListener() {
        document.getElementById('report_form').addEventListener('submit', get_data);
    }
